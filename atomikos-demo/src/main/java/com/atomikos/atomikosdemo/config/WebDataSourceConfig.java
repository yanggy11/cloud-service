...
@ComponentScan
@Data
@MapperScan(basePackages = "com.atomikos.atomikosdemo.dao1",sqlSessionFactoryRef = "resourceSqlSessionFactory")
public class WebDataSourceConfig {
    @Bean(name = "resource",initMethod="init",destroyMethod="close")
    public DataSource resourcedataSource() throws SQLException{
        DruidXADataSource dataSource=new DruidXADataSource();
        //DruidDataSource dataSource = new DruidDataSource();
        dataSource.setDriverClassName("com.mysql.jdbc.Driver");
        dataSource.setUrl("jdbc:mysql://39.107.97.132:3306/web?useUnicode=true&characterEncoding=utf8&verifyServerCertificate=false&useSSL=true");
    ...
    public SqlSessionFactory resourceSqlSessionFactory(@Qualifier("resource") DataSource dataSource)
            throws Exception {
        SqlSessionFactoryBean bean = new SqlSessionFactoryBean();
        bean.setDataSource(dataSource);
        bean.setMapperLocations(new PathMatchingResourcePatternResolver().getResources("classpath:sql-mapper/web/*.xml"));
    ...
    public SqlSessionTemplate resourceSqlSessionTemplate(
            @Qualifier("resourceSqlSessionFactory") SqlSessionFactory sqlSessionFactory) throws Exception {
